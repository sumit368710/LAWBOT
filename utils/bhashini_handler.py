...
class BhashiniHandler:
    ...
    def _headers(self):
        return {
            "Authorization": f"Bearer {self.api_key}",   # ✅ FIXED
    ...
    def translate(self, text, source_lang, target_lang):
        ...
        try:
            ...
            print("🔍 Translation Response:", resp.text)
    ...
    def text_to_speech(self, text, lang, gender="female"):
        ...
        service_id = (
            TTS_SERVICE_EN if lang == "en"
            else TTS_SERVICE_INDIC
        )
        ...
        payload = {
            ...
            "inputData": {
                "input": [{"source": text[:500]}],   # ✅ limit for stability
